...
contract DogeCake is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Cake", "DCAKE") {
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DogeCake_Doge_Dividend_Tracker", "DogeCake_Doge_Dividend_Tracker", 0xbA2aE424d960c26247Dd6c32edC70B295c744C43) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }
